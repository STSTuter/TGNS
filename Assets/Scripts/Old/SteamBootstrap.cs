...
/// cleanly on exit. Exposes the minimal state the rest of the prototype (SteamLobbyManager,
/// DebugUI) needs: whether init succeeded, the local player's display name and SteamID.
